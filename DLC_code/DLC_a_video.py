...
from escape_visualization_lite import visualize_escape
    ...
    def get_coordinates(self, videos):
        ...
        for video_path in videos:
            ...
            # make a new coordinates
                ...
                self.coordinates = filter_and_transform_dlc(self.dlc_settings, self.coordinates, 0, 0, session['Registration'], plot=False, filter_kernel=7)
